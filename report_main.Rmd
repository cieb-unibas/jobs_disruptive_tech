...
However, how prevalent are specific technologies across companies and institutions in Switzerland? To approach this, we calculate for every technology field the share of institutions in our data sample that has published at least one job posting with a connection to the given technology.  Figure 2 depicts the results for technology fields where we detected at least 50 institutions with job postings related to that technology.

<hr class="hr_red">
#### **Figure 2: Spread of Disruptive Technologies Across Employers in Switzerland**
...
For other technologies, it is not intuitively clear how widespread they have become though. For example, Solar Power, Search Engine and Online Streaming technologies have a similar, yet below-average share of employers with job postings related to these technologies in our sample. But it could be, that some of them are much more heavily dominated by few big employers. Using the so-called <a href= https://en.wikipedia.org/wiki/Herfindahl%E2%80%93Hirschman_index target = “_blank”> Herfindahl-Hirschmann index</a> measure as a proxy, Figure 3 illustrates the concentration of job postings among employers within the ten most prevalent disruptive technologies (note that we exclude postings published by recruiting companies such as Adecco or Randstad).
...
As expected, technologies that are more prevalent across employers (e.g., Social Networking), are also less dominated by few big players. However, interesting differences emerge, for example, between the three aforementioned technologies Solar Power, Search Engine and Online Streaming. Whereas Online Streaming showed a similar prevalence as the other two technologies in Figure 2, its job postings are the most concentrated across all fields. Its postings are almost 5 times as concentrated among employers compared to Search Engine technologies, and about 2.5 times as concentrated compared to Solar Power. Only Virtual Reality technology shows a similarly high concentration, which is likely due to few big employers such as <a href= https://www.metacareers.com/locations/zurich/?p[offices][0]=Zurich%2C%20Switzerland&offices[0]=Zurich%2C%20Switzerland target = “_blank”> Meta</a> (see also, <a href= https://www.linkedin.com/feed/update/urn:li:activity:6945992073892270080/ target = “_blank”> this short overview</a> regarding the prospects of virtual reality in Switzerland).

At the other end of the spectrum, job postings seem to be a lot more dispersed across several employers for Social Network, Cloud Computing and Machine Learning technologies. Since especially the latter two technologies are expected to further evolve and are sometimes labelled as <a href= https://en.wikipedia.org/wiki/General-purpose_technology target = “_blank”>general purpose technologies</a>, their relatively substantial spread to date can be understood as an encouraging sign for the future prospect of the Swiss economy. 
