...
As expected, technologies that are more prevalent across employers (e.g., Social Networking), are also less dominated by a few big players. However, interesting differences emerge, for example, between the three aforementioned technologies Solar Power, Search Engine, and Online Streaming. Whereas Online Streaming showed a similar prevalence as the other two technologies in Figure 2, its job postings are the most concentrated across all fields. Its postings are almost 5 times as concentrated among employers compared to Search Engine technologies, and about 2.5 times as concentrated compared to Solar Power. Only Virtual Reality technology shows a similarly high concentration, which is likely due to few big employers such as <a href= https://www.metacareers.com/locations/zurich/?p[offices][0]=Zurich%2C%20Switzerland&offices[0]=Zurich%2C%20Switzerland target = “_blank”> Meta</a> (see also, <a href= https://www.linkedin.com/feed/update/urn:li:activity:6945992073892270080/ target = “_blank”> this short overview</a> regarding the prospects of virtual reality in Switzerland).

At the other end of the spectrum, job postings seem to be a lot more dispersed across several employers for Social Network tasks, Cloud Computing, and Machine Learning technologies. Since especially the latter two technologies are expected to further evolve and are sometimes labeled as <a href= https://en.wikipedia.org/wiki/General-purpose_technology target = “_blank”>general purpose technologies</a>, their relatively substantial spread to date can be understood as an encouraging sign for the future prospect of the Swiss economy.
